...
const _CHARACTER_MODELS = defs.CHARACTER_MODELS
// const _CHARACTER_MODELS = {
//   zombie: {
//     base: "mremireh_o_desbiens.fbx",
//     path: "not_my_resources/characters/zombie.glb",
//     animations: {
//       idle: "idle.fbx",
//       walk: "walk.fbx",
//       run: "run.fbx",
...
//     path: "not_my_resources/characters/guard.glb",
//     animations: {
...
//   sorceror: {
//     base: "Sorcerer.fbx",
//     path: "not_my_resources/characters/sorceror.glb",
//     animations: {
//       idle: "Sorcerer Idle.fbx",
//       walk: "Sorcerer Walk.fbx",
//       run: "Sorcerer Run.fbx",
//       dance: "Sorcerer Dance.fbx",
//     },
//     nameOffset: 30,
//   },
// }
...
class FloatingName {
  ...
  Init_() {
    const modelData = _CHARACTER_MODELS.zombie //[this.params_.desc.character.class]
...
class AnimatedMesh {
  ...
  Load_() {
    ...
    loader.load(
      `${import.meta.env.BASE_URL}not_my_resources/characters/guard.glb`,
      (gltf) => {
        ...
        this.manager_.load(modelData.animations.idle, (a) => {
          _OnLoad("idle", a)
        })
        this.manager_.load(modelData.animations.walk, (a) => {
          _OnLoad("walk", a)
        })
        this.manager_.load(modelData.animations.run, (a) => {
          _OnLoad("run", a)
        })
        this.manager_.load(modelData.animations.dance, (a) => {
          _OnLoad("dance", a)
        })
...
class BasicMMODemo {
  ...
  _Initialize() {
    ...
    const texture = loader.load([
      "not_my_resources/posx.jpg",
      "not_my_resources/negx.jpg",
      "not_my_resources/posy.jpg",
      "not_my_resources/negy.jpg",
      "not_my_resources/posz.jpg",
      "not_my_resources/negz.jpg",
    ])
